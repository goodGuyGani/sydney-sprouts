        ...
        {payload
          ...
          .map((item, index) => {
            ...
            if (item.payload && typeof item.payload === "object" && item.payload !== null) {
              ...
              if ("fill" in payloadObj && typeof payloadObj.fill === "string") {
                payloadFill = payloadObj.fill
              }
            }
    ...
    >
      {payload
        ...
        .map((item, index) => {
          ...
          const itemConfig = getPayloadConfigFromPayload(config, item, key)
          const itemValue = item.value != null ? String(item.value) : String(index)
          const itemColor = item.color ? String(item.color) : undefined
...
function getPayloadConfigFromPayload(
  ...
  const getConfigValue = (configKey: string): ChartConfig[string] | undefined => {
  ...
  return getConfigValue(configLabelKey) ?? getConfigValue(key)
}
